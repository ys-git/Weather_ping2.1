...
public class Main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        city = (TextView)findViewById(R.id.tv);
        ...
        asyncTask.execute("12.840","80.903"); //  asyncTask.execute("Latitude", "Longitude")
   ...
   /* @Override
    public void onProviderDisabled(String provider) {
        ...
        /*Toast.makeText(Main.this, "Please Enable Location and restart the app", Toast.LENGTH_SHORT).show();
    }
